...
| `api-contract.md` | HTTP API, preprocessing preview, UI operation contract, response metadata, errors, and retry behavior. | Changing `/api/*`, operation IDs, preprocessing output, analysis metadata, or frontend API calls. | Active | 2026-05-19 |
